...
The dataset is publicly available at Roboflow: https://app.roboflow.com/test-bx6i4/cottony-mass-euphyllura-olivina-5ue4p/

All mask prediction results of ten COD techniques are available in folder [results](results).
